        ...
        {!submitted ? (
          <div>
            ...
            <div className="inquiry-modal-header text-center mb-4">
              ...
              <h3 className="inquiry-modal-title fw-semibold mt-1">Request Price & Customization</h3>
          ...
          <div className="text-center py-4">
            ...
            <h3 className="inquiry-modal-title fw-semibold">Thank You, {formData.name}!</h3>
