...
const Header = () => {
  ...
  const { callNow, openWhatsApp, openInquiryModal } = useInquiry();
  ...
  return (
    <div className="header-wrapper sticky-top">
      ...
      {/* Main Navbar */}
      <nav className="navbar navbar-expand-xl navbar-light custom-navbar py-3">
        <div className="container-fluid px-lg-5">

          {/* Toggler for Mobile/Tablet */}
          <button
            className="navbar-toggler border-0 order-first"
            type="button"
          ...
          <div className="collapse navbar-collapse order-3 order-xl-1 navbar-collapse-custom" id="navbarContent">
            <ul className="navbar-nav gap-xl-3 my-3 my-xl-0">
          ...
          <Link className="navbar-brand d-flex align-items-center logo-brand order-2 mx-auto mx-xl-0" to="/">
            <img src={logoImage} alt="WOWO Studio Logo" className="logo-image" />
          </Link>

          {/* Right Side: Social Media Icons & Request Price Action */}
          <div className="d-flex align-items-center gap-2.5 order-4 header-right-section">
            ...
            <button type="button" onClick={() => openInquiryModal()} className="btn btn-request-header d-none d-md-inline-block">
              Request Price
            </button>
          </div>
